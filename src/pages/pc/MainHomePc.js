...
const MainHomePc = () => {
    ...
    const loadSwiperJs = () => {
        importJs('common-js', '/resources/js/common.js');
    }
    ...
    <div className="wrapper main" id="wrapper">
        ...
        <MainHeaderPc selectedGnbIndex={0} popVisible={true} />
            ...
            <div className="contents" id="contents">
                ...
                <section className="sec2">
                    <div className="sec-text">
                        ...
                        <p className="sec-desc">개인을 위한 메타버스 서비스는 많지만<br/>학교 전용 메타버스 서비스가 없어서 시도하기 막막하셨죠?<br/>Uverse는 학생, 교사, 학부모에  꼭 필요한 기능만을 모아<br/>우리 학교만의 메타버스 공간을 만들어 드리는 플랫폼입니다.</p>
                    </div>
                </section>
                <section className="sec3">
                    <div className="sec-text">
                        ...
                        <h3 className="sec-title">
                            <img src="/resources/images/main_logo_bk.png" alt="유버스 로고 이미지" />  의<br/>주요 서비스를 확인하세요</h3>
                        <p className="sec-desc"><span>안전하게 우리 학교 학생만 접속할 수 있어요</span><br />인증 받은 우리 학교 학생만<br />따로 앱 설치할 없이 전용 웹페이지로<br/>언제 어디서나 쉽게 접속할 수 있어요.</p>
                    </div>
                    <img src="/resources/images/main_sec3_01.png" alt="주요 서비스를 확인하세요 이미지" />  
                </section>
                <section className="sec4">
                    <div className="sec-text">
                        <h3 className="sec-title">우리 대학만의<br />메타버스 캠퍼스를<br /> 즐길 수 있어요</h3>
                        <p className="sec-desc">
                            학교 건물과 똑같아서 더욱 실감나는 메타버스 캠퍼스에서 <br />
                            강의는 물론 도서관, 입학/취업박람회, 상담, 홍보관, 동아리 모임<br />
                            까지 지속적으로 사용할 수 있는 학교 특화기능을 통해 또하나의 <br />
                            캠퍼스 라이프를 즐겨보세요.
                        </p>
                ...
                <section className="sec5 sec4">
                    ...
                    <div className="sec-text">
                        <h3 className="sec-title">메타버스 스쿨에서<br />공부도 하고<br />친구도 만날 수 있어요</h3>
                        <p className="sec-desc">
                            온라인 수업이 필요할 땐 언제 어디서나 메타버스 스쿨로 등교할<br />
                            수 있어요. 나만의 아바타로 수업을 듣고 친구들과 스터디하면<br />
                            학습 몰입도와 참여율이 높아져요.<br />
                        </p>
                ...
                <section className="sec6">
                    <div className="sec6_content">
                        <div className="sec-text">
                            ...
                            <h3 className="sec-title">친구들과 소통할 수 있어요</h3>
                            <p className="sec-desc">
                    ...
                    <ul className="sec6_menu">
                        <li><p>가입 문의</p><button type="button" className="sec6_btn">문의하기</button></li>
                        <li><p>제휴 문의</p><button type="button" className="sec6_btn">문의하기</button></li>
                        <li><p>자주하는 질문/1:1문의</p><button type="button" className="sec6_btn">바로가기</button></li>
                    </ul>
                </section>

        ...
        <div className="layer certi">
            <dl>
                <dt className="layerHeader mgb10">
                    <h1 className="layerTit">보호자(법정대리인) 동의</h1>
                        ...
                        { selectedTabIndex === 0 ? (
                            <div className="pdt40"> 
                                <div className="form-control mgb8">
                                    <input type="text" placeholder="보호자 이름" />
                                </div>
                                ...
                                <div className="form-control-group mgb12">
                                    <div className="form-control" style={{position:'relative'}}>
                                        ...
                                        <span className="count">3:00 남음</span>
                                    </div>
                                    <div className="auto">
                ...
                { isBun01 ? (
                    <button className="SecBtn bdGy" onClick={ e => { setIsBun01(false); }}>확인</button>
                ) : (
                    <button className="SecBtn02" onClick={ e => { setIsBun01(true); }}>확인</button>
                )}
            </dl>
        </div>
    )

    ...
    return (
        ...
        <div className="UnKnowBtn">
            <div className="Btns">
                ...
                <button onClick={ e => { setPopName('Secession'); }}>0515 탈퇴 팝업창-01</button>
                <button onClick={ e => { setPopName('SecessionPop'); }}>0515 탈퇴 팝업창-02</button>
                ...
                <button onClick={ e => { setPopName('More14'); }}>More14/모달팝업_공지사항 비활성화</button>
                ...
                <button onClick={ e => { setPopName('Under14'); }} style={{}}>Under14/ 0403추가팝업/만 14세 미만이신가요?</button>

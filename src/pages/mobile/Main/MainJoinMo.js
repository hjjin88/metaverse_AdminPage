...
import JoinReceiptMo from "../Popup/JoinReceiptMo";
...
const MainJoinMo = () => {
    ...
    return (
        <div className="wrapper main" id="wrapper">
            ...
            <main className="container Partnership join">
                <div className="contents" id="contents">
                    <section className="Partnership join" id="Partnership">
                        ...
                        <form action="">
                            <fieldset className="form">
                                <legend>제휴 문의</legend>
                                <dl>
                                    <dt className="form-label"><label for="이름">이름 <span className="required">필수입력</span></label></dt>
                                    <dd>
                                ...
                                <dl>
                                    <dt className="form-label"><label for="연락처">연락처 <span className="required">필수입력</span></label></dt>
                                    <dd>
                                ...
                                <dl>
                                    <dt className="form-label"><label for="학교 이름">학교 이름 <span className="required">필수입력</span></label></dt>
                                    <dd>
                                ...
                                <dl>
                                    <dt className="form-label"><label for="이메일 주소">이메일 주소 <span className="required">필수입력</span></label></dt>
                                    <dd>
            ...
            { popSubmitOpened && (
                <JoinReceiptMo togglePop={toggleSubmitPop} />
            )}  
        </div>  
    )
}

export default MainJoinMo;
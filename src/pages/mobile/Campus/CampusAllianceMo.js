                ...
                <section className="Partnership alliance" id="Partnership">
                    ...
                    <form action="">
                        <fieldset className="form">
                            ...
                            <dl>
                                <dt className="form-label"><label htmlFor="성함">성함 <span className="required">필수입력</span></label></dt>
                                <dd>
                                ...
                                <dd>
                                    <div className="form-control table">
                                        ...
                                        <ul className="Privacy">
                                            ...
                                            <li>※ 또한 귀하께서 서비스의 이용 기록 삭제를 하시는 경우에는 지체 없이 관련 정보들은 파기됩니다. 다만, 이용자에게 제공되는 서비스가 있는 경우 VoC 대응을 위해 3년간 관련 정보를 보관할 수 있으며, 또한 관계법령의 규정에 의하여 개인정보를 보유할 필요가 있는 경우에는, 해당 법령에서 정한 일정 기간 동안 정보를 보관할 수 있습니다.</li>
...
export default CampusAllianceMo;
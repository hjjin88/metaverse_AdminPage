...
const AgreeMo = ({ togglePop }) => {

    return (
    <div className="layer mem Agree">
        <div>
            ...
            <div className="layer-contents">
                <dl>
                    <dt className="form-label center">개인정보 정보 제3자 제공동의</dt>
                    <dd className="agree-cotents inTxt13_03">
                        <p className="text pdb20">
                            본인은 아래의 내용을 확인하고 숙명여자대학교가 아래와 같이
                            본인의 개인정보를 스노우버스(Snowverse)의 학생/임직원
                            임증을 통한 회원가입 및 서비스 이용을 위해 활용함에 동의합니다.
                        </p>
                        <ol className="text pdb20">
            ...
            <div className="layer-btns pd020">
                <button type="button" className="SecBtn01" onClick={togglePop}>거부</button>

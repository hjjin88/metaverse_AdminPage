        ...
        <div>
            ...
            <div className="layer-contents ">
                <div className="inner-html mgb16">
                    <p className="text center">사용하실 닉네임을 입력하세요.</p>
                </div>
            ...
            { isBun01 ? (
                <button type="button" className="SecBtn bdWt" onClick={ e => { setIsBun01(false); }}>변경</button>
            ) : (

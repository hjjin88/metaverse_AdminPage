...
const MemMo = ({ togglePop }) => {
    ...
    <div className="layer mem connect">
        <div>
            ...
            <div className="layer-contents pdt20">
                <fieldset className="form">
                    <legend>학생/교직원 인증</legend>
                    <dl>
                        <dt className="form-label">필수정보</dt>
                        <dd>
                            ...
                            <div className="form-control-group pdb14">
                        ...
                        <dt className="inTxt14 pdb4">회원구분</dt>
                        <dd>
                            <div className="ui-tab">
                                ...
                                { selectedTabIndex === 0 ? (
                                    ...
                                    <div className="tab">
                                        <div className="form-control-group">
                                            <div className="form-control" style={{position:'relative'}}>
                                                <input type="text" placeholder="교번" id="교번" />
                                            </div>
                                            <div className="auto">
                                                <button type="button" className="btn">확인</button>
                                            </div>
                                    ...
                                    <dl className="dblCheck">
                                        <dt className="inTxt14 pdb4">소속 학교 내 닉네임 중복 확인</dt>
                                        <dd>
            ...
            <div className="layer-btns pd016">
                <button type="button" className="SecBtn02" disabled>이전</button>

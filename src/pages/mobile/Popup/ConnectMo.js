...
const ConnectMo = ({ togglePop }) => {

    const [selectedTabIndex, setSelectedTabIndex] = useState(0);

    return (
    <div className="layer mem connect">
        <div>
            <div className="layerHeader mgb24">
            ...
            <div className="layer-contents">
                <fieldset className="form">
                    ...
                    <dl>
                        <dt className="form-label pdt30">이메일 인증</dt>
                        <dd className="sns-wrap">
                            <button type="button" className="btn btn-google">구글로 시작하기</button>
                        </dd>
                    </dl>
                    <dl>
                        <dt className="form-label pdt20">필수정보</dt>
                        <dt className="inTxt14_02 pdt14 pdb4">회원구분</dt>
                        <dd>
                            <div className="ui-tab">
                                ...
                                { selectedTabIndex === 0 ? (
                                    ...
                                    <dl className="dblCheck pdb20">
                                        <dt className="inTxt14_02 pdt14 pdb4">소속 학교 내 닉네임 중복 확인</dt>
                                        <dd>
            ...
            <div className="layer-btns pd016">
                <button type="button" className="SecBtn02" onClick={togglePop}>이전</button>

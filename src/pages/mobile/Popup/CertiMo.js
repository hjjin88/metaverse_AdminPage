...
const CertiMo = ({ togglePop }) => {
    ...
    return (
        <div className="layer certi">
                    ...
                    <div className="ui-tab">
                        ...
                        { selectedTabIndex === 0 ? (
                            <div className="pdt40"> 
                                ...
                                <p className="form-notice">*외국인은 외국인 등록번호를 입력해 주세요.</p>
                            ...
                            <div className="pdt24">
                                <p className="inTxt12_03 pdb24">통신사 인증 앱(PASS)이용하여 간편하게 본인확인 가능합니다.</p>
                                <div className="form-control mgb8">
                                    <input type="text" placeholder="이름" />
                                </div>
                                <div className="form-control-group mgb8">
                                ...
                                <div className="form-check terms-wrap pdb30">
                                    <input type="checkbox" name="Agree2" id="Agree2" />
                                    <label htmlFor="Agree2">다음부터 자동으로 로그인하기</label>
                                </div>
                            </div>
            ...
            { isBun01 ? (
                <button className="SecBtn bdWt" onClick={ e => { setIsBun01(false); }}>본인인증 및 로그인</button>
            ) : (
                <button className="SecBtn02" onClick={ e => { setIsBun01(true); }}>본인인증 및 로그인</button>
            )}
            </dl>
        </div>
    )

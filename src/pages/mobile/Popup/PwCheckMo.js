        ...
        <div className="">
            ...
            <div className="layer-contents pdt24">
                <fieldset className="form">
                    ...
                    <p className="form-notice pdb26">가입하신 이메일의 인증번호를 확인한 후 비밀번호를 재설정할 수 있습니다.</p>
                    <dl>
                    ...
                    <dl className="pdb28">
                        ...
                        <dt className="form-label pdt18">새 비밀번호 확인</dt>
                        <dd>
                            <div className="form-control-group">
                                <div className="form-control" style={{position:'relative'}}>

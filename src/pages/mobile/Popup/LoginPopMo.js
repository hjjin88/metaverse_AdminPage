            ...
            <fieldset className="form">
                ...
                <dl>
                    ...
                    <dd className="Avatar">
                        ...
                        <p className="text-center mgt16"><span>아바타 외형은 마이룸에서 <br />언제든지 변경 가능합니다.</span></p>
                    </dd>
                </dl>
                { isBun01 ? (
                    <button type="button" className="SecBtn bdWt mgt8" onClick={ e => { setIsBun01(false); }}>입장</button>
                ) : (
                    <button type="button" className="SecBtn02 mgt8" onClick={ e => { setIsBun01(true); }}>입장</button>
                )}
                <p className="text-center-sm mgt24"><span>이미 보유한 아바타로 입장하시려면 <br />로그인하세요.</span></p>
                { isBun02 ? (

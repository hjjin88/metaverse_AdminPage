...
import AFMMicroscopyPracticeBtn from "./AFMMicroscopyPracticeBtn";

const AFMMicroscopyPractice = () => {
  ...
  return (
    <div id="unity_container">
      ...
      <div className="wrap">
        ...
        <AFMMicroscopyPracticeBtn popName={popName} setPopName={setPopName}/>
      </div>
    </div>
  )
}

export default AFMMicroscopyPractice;
